...
def _SanitizeTag(t):
  ...
  # FIX 1 (XSS): Extended the disallowed_attributes list to include event
  # handlers that were missing from the original blacklist. The original list
  # omitted 'onerror', 'onmouseover', 'onmouseenter', and others — allowing
  # the <img src="x" onerror="..."> XSS attack to succeed.
  # Note: a whitelist approach (only allow known-safe attributes) is always
  # more secure than a blacklist, but this fix closes the immediate gap.
  disallowed_attributes = [
      'onabort', 'onblur', 'onchange', 'onclick', 'ondblclick',
      'ondrag', 'ondragend', 'ondragenter', 'ondragleave', 'ondragover',
      'ondragstart', 'ondrop',
      'onerror',        # <-- was missing; used in the img XSS exploit
      'onfocus',
      'oninput', 'oninvalid',
